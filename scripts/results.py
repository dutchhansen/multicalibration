...
def experiments_table(model_name, 
    ...
    Draws data from csv saved as results/{model_name}/{dataset_name}_{model_name}.csv.
    ...
    results = pd.read_csv(f'{results_dir}/{model_name}/{dataset_name}_{model_name}.csv')
